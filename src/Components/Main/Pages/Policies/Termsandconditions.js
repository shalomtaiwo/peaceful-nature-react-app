...
const termsandconditions = () => {
  return (
    <div className="extraPages">
      ...
      <div className="terms">
        <p>Welcome to Peaceful Nature!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Peaceful Nature's Website, located at peacefulnature.co.za.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Peaceful Nature if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing Peaceful Nature, you agreed
          to use cookies in agreement with the Peaceful Nature's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Peaceful Nature and/or its licensors own the
          intellectual property rights for all material on Peaceful Nature. All
          intellectual property rights are reserved. You may access this from
          Peaceful Nature for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Peaceful Nature</li>
          <li>Sell, rent or sub-license material from Peaceful Nature</li>
          <li>Reproduce, duplicate or copy material from Peaceful Nature</li>
          <li>Redistribute content from Peaceful Nature</li>
        </ul>
        ...
        <p>
          ...
          Peaceful Nature does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Peaceful Nature,its agents and/or affiliates.
          ...
          Peaceful Nature shall not be liable for the Comments or for any
        ...
        <p>
          Peaceful Nature reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Peaceful Nature a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Peaceful Nature; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Peaceful Nature. Please include your name, your
        ...
        <p>
          No use of Peaceful Nature's logo or other artwork will be allowed for
