				...
				<>
					{items.map((neworder, index) => (
						<>
							...
							>
								<Text size={14}>
									{neworder?.OrderDate} Order NO. {neworder?.orderNo}
								</Text>
							</div>
							<Table
									...
									<tr key={index}>
										<td>
											...
											>
												<ImageGallery
													...
													items={slides(neworder?.products)}
												/>
											</div>
										</td>
										<td>
											<Title order={5}>R{neworder.Total}</Title>
										</td>
										<td>
											...
											<Anchor
												target="_blank"
												color={
													neworder?.tracking === "processing" ? "green" : "red"
												}
												href={
													neworder?.tracking === "processing"
														? "#/"
														: neworder?.tracking
												}
											>
										...
										<td>
											<Button
												...
												onClick={() => viewInvoice(`${neworder.id}`)}
												variant="subtle"
												color="green"
											>
												Order Details
