  ...
  if (isEmpty)
    return (
      ...
      >
        ...
        <Button color={"lime"} onClick={shopping}>
          Go to Shop
        </Button>
      </div>
    );
        ...
        >
          <Box sx={{ width: "100%", padding: "20px" }}>
            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
              <Stepper active={active} breakpoint="sm" color={"lime"}>
                <Stepper.Step label="Cart" description="Your cart">
                ...
                <Stepper.Step label="Checkout" description="Billing details">
                  <div className="checkoutState">
                    <div className="totalFlex flexAddress">
                ...
                <Stepper.Step label="Address" description="Shipping Address">
                  <div className="checkoutState">
                    <div className="totalFlex flexAddress">
                      <div className="addressFlex">
                      ...
                      <Modal opened={false}>
                        <Stack>
                          ...
                          />
                          <Button color="lime" onClick={createAddress}>
                            Save Address
                          </Button>
                        </Stack>
                      </Modal>
              ...
              >
                {active !== 0 && (
                  <Button color={"lime"} variant="light" onClick={prevStep}>
                    Back
                  </Button>
                )}
                {active !== 3 && (
